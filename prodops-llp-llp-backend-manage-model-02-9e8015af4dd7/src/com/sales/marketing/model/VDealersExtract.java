...
/**
 * The persistent class for the "v_dealer_report" database table.
 * 
 */
@Entity
@Table(name="v_dealer_report")
@NamedQuery(name="VDealersExtract.findAll", query="SELECT v FROM VDealersExtract v")
public class VDealersExtract implements Serializable {
	...
	public String toString() {
		return "VDealersExtract [dealerId=" + dealerId + ", dealerName=" + dealerName + ", dealerStatus=" + dealerStatus
				+ ", stateName=" + stateName + ", street1=" + street1 + ", street2=" + street2 + ", city=" + city
				+ ", zipCode=" + zipCode + ", stateCode=" + stateCode + ", country=" + country
				+ ", dealerFraudIndicator=" + dealerFraudIndicator + ", email=" + email + ", contactTitle="
