...
@Entity
@Table(name = "credit_app_dealers")
public class CreditAppDealersEntity implements Serializable {
	...
	public String toString() {
		return "CreditAppDealersEntity [lenderId=" + lenderId + ", lenderDealerId=" + lenderDealerId
				+ ", legalDealerName=" + legalDealerName + ", dbaDealerName=" + dbaDealerName + ", street=" + street
				+ ", city=" + city + ", state=" + state + ", zipcode=" + zipcode + ", phone=" + phone + ", fax=" + fax
				+ ", status=" + status + ", dealersource=" + dealersource + ", creationUserI=" + creationUserI
				+ ", creationD=" + creationD + ", lastUpdatedUserI=" + lastUpdatedUserI + ", lastUpdatedD="
				+ lastUpdatedD + "]";
	}
